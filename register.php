...
<body class="hold-transition register-page">
  ...
  <?php include 'emp_actions/connection.php';?>
  ...
  <div class="register-box">
    ...
    <div class="card">
      <div class="card-body register-card-body">
        ...
        <form id="myform" action="emp_actions/register_action.php"  method="post">
          ...
          <div class="row">
           ...
           <!-- /.col -->
           <div class="col-4">
            <button id="submit" value="submit" type="submit" class="btn btn-primary btn-block">Register</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
